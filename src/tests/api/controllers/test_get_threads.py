...
class TestGetThreads:
    ...
    @pytest.mark.parametrize(
        ...
        [
            ...
            (
                # patcher
                {"target": "app.models.thread.Thread.find_list", "return_value": []},
                # expected
                    ...
                    "return_value": [
                        {
                            ...
                            "title": "title1",
                            "created_at": datetime(
                                2019, 1, 2, 3, 4, 5, 123456, tzinfo=timezone.utc
                            ),
                            "updated_at": datetime(
                                2020, 2, 3, 4, 5, 6, 234567, tzinfo=timezone.utc
                            ),
                        },
                        {
                            "id": "2",
                            "title": "title2",
                            "created_at": datetime(
                                2021, 11, 12, 13, 14, 15, 0, tzinfo=timezone.utc
                            ),
                            "updated_at": datetime(
                                2022, 12, 13, 14, 15, 16, 1, tzinfo=timezone.utc
                            ),
                        },
                    ],
                },
